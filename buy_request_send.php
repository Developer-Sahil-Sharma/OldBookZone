...
<link rel="Website Icon" type="png" href="oldbookzone-favicon-color.png">
    ...
    <meta name="description" content="Welcome to OldBookZone. for buy and sell old books" />
...
$sql = "SELECT * FROM sell_book where ID=$id";
...
if ($result->num_rows > 0) {
   while ($row = $result->fetch_assoc()) {
        ...
        $bprice = $row["b_price"];
        $bdes = $row["b_des"];
        $sellers_emails = $row["seller_email"];
...
$conn->close();
                ...
                echo '<p class="card-text mb-auto">Price: '.$bprice.'</p>' ;
 ...
 ?>
    ...
    <div class="container my-4">
      <h2>Send buying request to Seller</h2>
      <form  method="post" >
        ...
        <div class="form-group">
          <label for="exampleFormControlTextarea2">Email of Buyer</label>
          <input
            type="email"
            class="form-control"
            name="buyemail"
...
if(isset($_POST['send_mail'])) {
    ...
    $buy_email = $_POST["buyemail"];
        ...
        try {
            ...
            $mail->addAddress($sellers_emails, 'OldBookZone'); //Add a recipient
...
<div class='container'>
    <h2>Book Inquiry</h2>
    <p>Dear sir/ma'am,</p>
    <p>Your book <strong> $bname </strong> is wanted to be purchased by:</p>
    <ul>
        <li><strong>Name:</strong> $buy_name</li>
        <li><strong>Phone no:</strong> $buy_no</li>
        <li><strong>Email:</strong> $buy_email</li>
    </ul>
    <p><strong>Message for you from buyer:</strong> $buy_msg</p>
