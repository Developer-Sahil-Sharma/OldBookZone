...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container my-4">
        ...
        if (isset($_POST['search_submit'])) {
            ...
            $sqll = "SELECT * FROM sell_book WHERE b_name LIKE '%$search%' OR a_name LIKE '%$search%'";
            ...
            while($rows = $resultt->fetch_assoc()) {
                ...
                echo '<p class="card-text mb-auto">Price: '.$rows["b_price"].'</p>' ;
                ...
                echo "<a href=\"buy_request_send.php?bookId=" . $rows["ID"] . "\" class=\"stretched-link\">" . $rows["seller_email"] . "</a>";
                echo '</div>';
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                //echo '<a href="buy_request_send.php" class="stretched-link" onclick="redirectToBuyRequest(\'' . $row["ID"] . '\')">'.$row["seller_email"].'</a>';
                echo "<a href=\"buy_request_send.php?bookId=" . $row["ID"] . "\" class=\"stretched-link\">" . $row["seller_email"] . "</a>";
                echo '</div>';
                echo '<div class="col-auto d-none d-lg-block">';
